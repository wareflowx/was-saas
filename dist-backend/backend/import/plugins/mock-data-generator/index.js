 ...
 * Unit of measures
 */
const UNITS = ['ea', 'kg', 'lb', 'm', 'l', 'gal', 'box', 'pallet'];
// ============================================================================
 ...
 * Generate mock users
 */
function generateMockUsers(warehouseId) {
    const users = [];
    const userData = [
 ...
 */
function generateMockPurchaseOrdersAndLines(warehouseId, suppliers, products) {
 ...
 */
function generateMockReceptionsAndLines(warehouseId, suppliers, purchaseOrders, purchaseOrderLines) {
    const receptions = [];
 ...
 */
function generateMockOrdersAndLines(warehouseId, customers, products) {
    const orders = [];
    const orderLines = [];
 ...
 */
function generateMockPickingsAndLines(warehouseId, users, orders, orderLines) {
    const pickings = [];
    const pickingLines = [];
 ...
 */
function generateMockShipmentsAndLines(warehouseId, orders, orderLines) {
    const shipments = [];
    const shipmentLines = [];
 ...
 */
function generateMockReturnsAndLines(warehouseId, customers, orders, products) {
    const returns = [];
    const returnLines = [];
    const reasons = ['DAMAGED', 'WRONG_ITEM', 'CUSTOMER_REQUEST', 'DEFECTIVE', 'EXPIRED'];
    const reasonLabels = {
    ...
    const conditions = ['NEW', 'OPENED', 'DAMAGED', 'DEFECTIVE'];
    const resolutions = ['REFUND', 'REPLACE', 'REPAIR', 'CREDIT'];
 ...
 */
function generateMockRestockingsAndLines(warehouseId, users, products, locations) {
    const restockings = [];
    const restockingLines = [];
    const priorities = ['LOW', 'NORMAL', 'HIGH', 'URGENT'];
...
function getRandomType() {
    const types = ['inbound', 'outbound', 'transfer', 'adjustment'];
    return types[getRandomInt(0, types.length - 1)];
}
function getRandomReason(type) {
    const reasons = {
