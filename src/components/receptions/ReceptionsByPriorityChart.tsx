...
interface ReceptionsByPriorityChartProps {
  data: Array<{
    priority: string
    count: number
    fill: string
...
export function ReceptionsByPriorityChart({
  data,
  className,
}: ReceptionsByPriorityChartProps) {
  ...
  return (
    <Card className={className + " p-4"}>
      <CardHeader className="p-0 pb-2">
        <CardTitle className="text-sm">Receptions by Priority</CardTitle>
