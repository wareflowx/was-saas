...
interface SectorCapacityChartProps {
  data: Array<{
    sector: string
    occupancy: number
    fill: string
...
export function SectorCapacityChart({
  data,
  className,
}: SectorCapacityChartProps) {
  ...
  return (
    <Card className={className + " p-4"}>
      <CardHeader className="p-0 pb-2">
        <CardTitle className="text-sm">Capacity Utilization by Sector</CardTitle>
        <CardDescription className="text-xs">Top and bottom sectors by occupancy rate</CardDescription>
      </CardHeader>
