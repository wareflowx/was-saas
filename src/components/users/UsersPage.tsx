...
import type { UsersData } from "@/shared/schemas/entities"
      ...
      <div className="rounded-lg border bg-card p-4 flex items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <p className="text-sm text-muted-foreground">
            <span className="font-medium">Manage warehouse operators and staff</span> efficiently with comprehensive user management.
          </p>
        </div>
        <button
      ...
      <Dialog open={isInfoDialogOpen} onOpenChange={setIsInfoDialogOpen}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              Track and manage all warehouse personnel from operators to administrators
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-3">
                ...
                <div className="space-y-2 text-xs">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Warehouse pickers</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-2">
                    <div className="h-1.5 w-1.5 rounded-full bg-muted-foreground mt-1 flex-shrink-0" />
                    <div>
                      ...
                      <p className="text-muted-foreground">Warehouse managers</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="rounded-lg border bg-muted/50 p-4">
              <div className="flex items-center gap-2 mb-3">
                <div className="h-2 w-2 rounded-full bg-primary" />
                <h4 className="font-semibold text-sm">Users Table</h4>
              </div>
              <div className="grid grid-cols-2 gap-4 text-xs">
                <div className="space-y-2">
                  <p className="text-muted-foreground">
                    View and manage all warehouse personnel with role-based access control.
                  </p>
                  <div className="flex items-start gap-2">
                    <div className="h-1.5 w-1.5 rounded-full bg-muted-foreground mt-1 flex-shrink-0" />
                    <div>
                      <p className="font-medium text-foreground">Filters</p>
                      <p className="text-muted-foreground">Status, role, warehouse</p>
                    </div>
                  </div>
                </div>
                <div className="space-y-2">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Find by username or email</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-2">
                    <div className="h-1.5 w-1.5 rounded-full bg-muted-foreground mt-1 flex-shrink-0" />
                    <div>
                      ...
                      <p className="text-muted-foreground">Track last login</p>
                    </div>
                  </div>
                </div>
              </div>
